...
public class SaturnRing : MonoBehaviour {
    ...
    [Range(3, 360)]
    //Variable to set the segments of the ring
    public int segments = 3;
    //Variable to set how far from the center of the planet the ring starts
    public float innerRadius = 0.7f;
    //Variable to set thickness of the ring
    public float thickness = 0.5f;
    //Assign a material to the rings
